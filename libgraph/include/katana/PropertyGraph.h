...
public:
  ...
  template <typename PGView>
  Result<PGView> BuildViewFromExistingTopologies() const noexcept {
    return KATANA_CHECKED(
        pg_view_cache_.BuildViewFromExistingTopologies<PGView>(this));
  }
  ...
  Result<PGView> BuildViewFromExistingTopologies(
    ...
    return KATANA_CHECKED(
        pg_view_cache_.BuildViewFromExistingTopologies<PGView>(
            this, node_types, edge_types));
  }
